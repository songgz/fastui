...
namespace :fastui do
  ...
  task :system_data => :environment do
    ...
    entity_m_tab.m_properties = [tab_property0, tab_property1, tab_property2, tab_property3, tab_property4]
    ...
    t2.m_columns.create([{:title => 'ID', :m_property => tab_property0, :width => 35},
                         {:title => '标签名称', :m_property => tab_property1, :width => 75},
                         {:title => '备注', :m_property => tab_property2, :width => 75},
                         {:title => '只读', :m_property => tab_property3, :width => 75}
                        ])
    ...
    #                    ])
    t2.m_fields.create([{:title => 'ID', :m_property => tab_property0},
                        {:title => '标签名称', :m_property => tab_property1},
                        {:title => '备注', :m_property => tab_property2},
                        {:title => '只读', :m_property => tab_property3}
