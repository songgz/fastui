...
namespace :fastui do
  ...
  task :system_data => :environment do
    ...
    m_entity = Fastui::MEntity.create({:name => 'm_entity', :title => '实体', :entity_kind => entity_kind_app})

    m_window = Fastui::MEntity.create({:name => 'm_window', :title => 'm_window', :entity_kind => entity_kind_sys})
    ...
    m_tab = Fastui::MEntity.create({:name => 'm_tab', :title => 'm_tab', :entity_kind => entity_kind_sys})
    ...
    m_tab_included_tab_id = m_tab.m_properties.create({:name => 'included_tab_id', :title => '所属标签', :refable => m_tab})
    ...
    m_field = Fastui::MEntity.create({:name => 'm_field', :title => 'm_field', :entity_kind => entity_kind_sys})
    ...
    m_column = Fastui::MEntity.create({:name => 'm_column', :title => 'm_column', :entity_kind => entity_kind_sys})
    ...
    m_menu = Fastui::MEntity.create({:name => 'm_menu', :title => '菜单', :entity_kind => entity_kind_sys})
    ...
    m_menu_note = m_menu.m_properties.create({:name => 'note', :title => '备注', :refable => v_textarea})
    ...
    m_menu_item = Fastui::MEntity.create({:name => 'm_menu_item', :title => '菜单项', :entity_kind => entity_kind_sys})
    ...
    m_menu_item_note = m_menu_item.m_properties.create({:name => 'note', :title => '备注', :refable => v_textarea})
    m_menu_item_read = m_menu_item.m_properties.create({:name => 'read_id', :title => '是否只读', :refable => state})
    ...
    sys_menu = sys_win_menu.m_tabs.create(:title => '菜单', :m_entity => m_menu, :read => state_true, :entity_kind => entity_kind_sys,
                                          :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1)
    sys_menu.m_columns.create([{:title => 'ID', :m_property => m_menu_id, :width => 35, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                               ...
                               {:title => '备注', :m_property => m_menu_note, :width => 75, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    sys_menu.m_fields.create([{:title => 'ID', :m_property => m_menu_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '名称', :m_property => m_menu_title, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '备注', :m_property => m_menu_note, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '实体种类', :m_property => m_menu_entity_kind_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '排序', :m_property => m_menu_seq, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '是否激活', :m_property => m_menu_actived_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '所属组织', :m_property => m_menu_org_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '创建人', :m_property => m_menu_createdby_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '更新人', :m_property => m_menu_updatedby_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                              {:title => '帮助', :m_property => m_menu_help, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1}
                             ])


    sys_menu_item = sys_win_menu.m_tabs.create(:title => '菜单项', :m_entity => m_menu_item, :read => state_true, :entity_kind => entity_kind_sys,
                                               :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1)
    sys_menu_item.m_columns.create([{:title => 'ID', :m_property => m_menu_item_id, :width => 35, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                    ...
                                    {:title => '备注', :m_property => m_menu_item_note, :width => 75, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                    ...
                                    {:title => '所属标签', :m_property => m_menu_id, :width => 75, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    sys_menu_item.m_fields.create([{:title => 'ID', :m_property => m_menu_item_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '名称', :m_property => m_menu_item_title, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '备注', :m_property => m_menu_item_note, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '实体种类', :m_property => m_menu_item_entity_kind_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '排序', :m_property => m_menu_item_seq, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '是否激活', :m_property => m_menu_item_actived_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '所属组织', :m_property => m_menu_item_org_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '所属标签', :m_property => m_menu_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '创建人', :m_property => m_menu_item_createdby_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '更新人', :m_property => m_menu_item_updatedby_id, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1},
                                   {:title => '帮助', :m_property => m_menu_item_help, :entity_kind => entity_kind_sys, :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1}
                                  ])


    menu_sys = Fastui::MMenu.create({:name => 'menu_sys', :title => '系统菜单',:entity_kind => entity_kind_sys,
                                        :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1})
    menu_sys_settings = Fastui::MMenuItem.create({:name => 'sys_tools', :title => '系统设置', :m_menu_id => menu_sys.id, :entity_kind => entity_kind_sys,
                                        :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1})
    menu_sys_settings_win_entity = menu_sys_settings.children.create({:name => 'win_entity', :title => '实体', :m_window_id => win_entity.id,:entity_kind => entity_kind_sys,
                                        :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1})
    menu_sys_settings_fastui = menu_sys_settings.children.create({:name => 'sys_fastui', :title => 'FastUI', :m_window_id => fastui.id,:entity_kind => entity_kind_sys,
                                        :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1})
    menu_sys_settings_win_menu = menu_sys_settings.children.create({:name => 'win_menu', :title => '菜单', :m_window_id => sys_win_menu.id,:entity_kind => entity_kind_sys,
                                        :seq => 1, :actived => state_true, :org => org_system, :createdby => person1, :updatedby => person1})
