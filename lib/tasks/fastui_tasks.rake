...
namespace :fastui do
  ...
  task :system_data => :environment do
    ...
    #[{name: 'id',title: 'ID',refable: v_number,entity_kind: 'sys',seq:1,actived:str,org:org_system,createdby:person1,updatedby:person1},
    ...
    m_window_actived_id = m_window.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
    ...
    m_tab_note = m_tab.m_properties.create({:name => 'note', :title => '备注', :refable => v_textarea,
                                            :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_tab_ro_id = m_tab.m_properties.create({:name => 'ro', :title => '只读', :refable => v_yesorno,
                                               :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_tab_entity_kind = m_tab.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind})
    m_tab_seq = m_tab.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                           :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_tab_actived_id = m_tab.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                  :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_field_property_id = m_field.m_properties.create({:name => 'm_property_id', :title => '所属属性', :refable => m_property,
                                                     :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_field_displayed = m_field.m_properties.create({:name => 'displayed', :title => '是否显示', :refable => v_yesorno,
                                                     :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_field_ro = m_field.m_properties.create({:name => 'ro', :title => '是否只读', :refable => v_yesorno,
                                                :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_field_entity_kind = m_field.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                          :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_field_seq = m_field.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                               :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_field_actived_id = m_field.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                      :entity_kind => 'sys', :seq => 8, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_column_width = m_column.m_properties.create({:name => 'width', :title => '列宽度', :refable => v_number,
                                                   :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_column_entity_kind = m_column.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                            :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_column_seq = m_column.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                 :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_column_actived_id = m_column.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                        :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_entity_note = m_entity.m_properties.create({:name => 'note', :title => '备注', :refable => v_textarea,
                                                  :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_entity_access_level = m_entity.m_properties.create({:name => 'access_level', :title => '访问级别', :refable => access_level,
                                                             :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_entity_entity_kind = m_entity.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                            :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_entity_seq = m_entity.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                 :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_entity_actived_id = m_entity.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                        :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_property_refable = m_property.m_properties.create({:name => 'refable', :title => '引用类型', :refable => refable_type,
                                                      :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_property_entity_kind = m_property.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                                :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_property_seq = m_property.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                     :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_property_actived_id = m_property.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                            :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_menu_name = m_menu.m_properties.create({:name => 'name', :title => '标识', :refable => v_text,
                                              :entity_kind => 'sys', :seq => 2, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_menu_entity_kind = m_menu.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                        :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_menu_seq = m_menu.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                             :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_menu_actived_id = m_menu.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                    :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_menu_item_name = m_menu_item.m_properties.create({:name => 'name', :title => '标识', :refable => v_text,
                                                        :entity_kind => 'sys', :seq => 2, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_menu_item_entity_kind = m_menu_item.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                                  :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_menu_item_seq = m_menu_item.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                       :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_menu_item_actived_id = m_menu_item.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                              :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    # 词汇
    m_glossary = Fastui::MEntity.create({:name => 'Fastui::MGlossary', :title => '词汇', :access_level => 'system', :entity_kind => 'sys',
                                         :seq => 1, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_glossary_name = m_glossary.m_properties.create({:name => 'name', :title => '标识', :refable => v_text,
                                                      :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_entity_kind = m_glossary.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                                :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_seq = m_glossary.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                     :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_actived_id = m_glossary.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                            :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    # 词汇项
    m_glossary_item = Fastui::MEntity.create({:name => 'Fastui::MGlossaryItem', :title => '词汇项', :access_level => 'system', :entity_kind => 'sys',
                                              :seq => 1, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    m_glossary_item_name = m_glossary_item.m_properties.create({:name => 'name', :title => '标识', :refable => v_text,
                                                                :entity_kind => 'sys', :seq => 4, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_item_entity_kind = m_glossary_item.m_properties.create({:name => 'entity_kind', :title => '实体种类', :refable => entity_kind,
                                                                          :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_item_seq = m_glossary_item.m_properties.create({:name => 'seq', :title => '排序', :refable => v_number,
                                                               :entity_kind => 'sys', :seq => 6, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    m_glossary_item_actived_id = m_glossary_item.m_properties.create({:name => 'actived', :title => '是否激活', :refable => v_yesorno,
                                                                      :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1})
    ...
    win_glossary_item.m_columns.create([
                                           ...
                                           {:title => '所属组织', :m_property => m_glossary_item_org_id, :width => 75, :entity_kind => 'sys', :seq => 1, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    win_glossary_item.m_fields.create([
                                          ...
                                          {:title => '是否激活', :m_property => m_glossary_item_actived_id, :displayed => true, :ro => state_false,
                                           :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
                                          {:title => '所属组织', :m_property => m_glossary_item_org_id, :displayed => true, :ro => state_false,
                                           :entity_kind => 'sys', :seq => 8, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    win_entity_property.m_columns.create([
                                             ...
                                             {:title => '引用类型', :m_property => m_property_refable, :width => 75, :entity_kind => 'sys', :seq => 1, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    win_entity_property.m_fields.create([
                                            ...
                                            {:title => '备注', :m_property => m_property_note, :displayed => true, :ro => state_false,
                                             :entity_kind => 'sys', :seq => 3, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
                                            {:title => '引用类型', :m_property => m_property_refable, :displayed => true, :ro => state_false,
                                             :entity_kind => 'sys', :seq => 5, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    sys_menu_item.m_columns.create([
                                       ...
                                       {:title => '所属组织', :m_property => m_menu_item_org_id, :width => 75, :entity_kind => 'sys', :seq => 1, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
    ...
    sys_menu_item.m_fields.create([
                                      ...
                                      {:title => '是否激活', :m_property => m_menu_item_actived_id, :displayed => true, :ro => state_false,
                                       :entity_kind => 'sys', :seq => 7, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
                                      {:title => '所属组织', :m_property => m_menu_item_org_id, :displayed => true, :ro => state_false,
                                       :entity_kind => 'sys', :seq => 8, :actived => true, :org => org_system, :createdby => person1, :updatedby => person1},
